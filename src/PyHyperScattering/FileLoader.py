...
class FileLoader():
    ...
    def loadFileSeries(self,basepath,dims,coords={},file_filter='',file_skip='donotskip',md_filter={},quiet=False,output_qxy=False,dest_qx=None,dest_qy=None,output_raw=False):
        '''
